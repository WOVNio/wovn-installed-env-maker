...
INSERT INTO `mt_association` VALUES (1,1,1,1,'2020-11-24 17:53:39',0,NULL,'2020-11-24 17:53:39',1,1);
...
INSERT INTO `mt_author` VALUES (1,'i96kfyho','MT','admin',NULL,NULL,1,'2020-11-24 17:45:47','relative','iwai@wovn.io',NULL,'',NULL,NULL,0,NULL,'2020-11-24 17:45:47','admin','admin','$6$SC9lPMcUg8q4qj5P$XVwz612I/ABju3lM9I1YWMPvqibxdGtLqfViGqAnmLnrwP6lL1Uk/bF8Sctms6xSkqqgw4nwsaLL9ATEJisRDg','ja',NULL,NULL,NULL,1,NULL,1,NULL,NULL);
...
INSERT INTO `mt_author_meta` VALUES (1,'favorite_sites',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,_binary 'BIN:SERG\0\0\0\0\0\0\0A\0\0\0-\0\0\01',NULL),(1,'favorite_websites',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,_binary 'BIN:SERG\0\0\0\0\0\0\0A\0\0\0-\0\0\01',NULL),(1,'list_prefs',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,_binary 'BIN:SERG\0\0\0\0\0\0\0H\0\0\0\0\0\0websiteH\0\0\0\0\0\00H\0\0\0\0\0\0\nlast_itemsA\0\0\0\0\0\0\0columnsA\0\0\0-\0\0\0name-\0\0\0\nblog_count-\0\0\0entry_count-\0\0\0\npage_count-\0\0\0content_type_count-\0\0\0\rcontent_count-\0\0\0parent_website\0\0\0rows-\0\0\050\0\0\0last_filter-\0\0\0_allpass',NULL),(1,'widgets',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,_binary 'BIN:SERG\0\0\0\0\0\0\0H\0\0\0\0\0\0dashboard:systemH\0\0\0\0\0\0activity_logH\0\0\0\0\0\0set-\0\0\0sidebar\0\0\0order-\0\0\0200\0\0\0updatesH\0\0\0\0\0\0order-\0\0\00\0\0\0set-\0\0\0sidebar\0\0\0notification_dashboardH\0\0\0\0\0\0order-\0\0\00\0\0\0set-\0\0\0main\0\0\0system_informationH\0\0\0\0\0\0order-\0\0\0100\0\0\0set-\0\0\0main\0\0\0mt_newsH\0\0\0\0\0\0set-\0\0\0sidebar\0\0\0order-\0\0\0100\0\0\0dashboard:user:1H\0\0\0\0\0\0notification_dashboardH\0\0\0\0\0\0order-\0\0\00\0\0\0set-\0\0\0main\0\0\0activity_logH\0\0\0\0\0\0set-\0\0\0sidebar\0\0\0order-\0\0\0200\0\0\0site_list_for_mobileH\0\0\0\0\0\0order-\0\0\050\0\0\0set-\0\0\0main\0\0\0updatesH\0\0\0\0\0\0order-\0\0\00\0\0\0set-\0\0\0sidebar\0\0\0mt_newsH\0\0\0\0\0\0set-\0\0\0sidebar\0\0\0order-\0\0\0100\0\0\0	site_listH\0\0\0\0\0\0set-\0\0\0main\0\0\0order-\0\0\0100',NULL);
...
CREATE TABLE `mt_blog` (
  ...
  `blog_archive_type` varchar(2000) DEFAULT NULL,
  `blog_archive_type_preferred` varchar(50) DEFAULT NULL,
...
INSERT INTO `mt_blog` VALUES (1,NULL,1,1,1,1,1,1,0,NULL,NULL,NULL,NULL,NULL,NULL,'Category,Individual,Monthly,Page','Individual',NULL,NULL,1,100,NULL,'2020-11-24 09:09:08','website',NULL,'richtext','1',1,'2020-11-24 17:53:38','none','ja',0,NULL,1,1,10,'html',NULL,0,NULL,14,0,'ja',NULL,1,2,NULL,'2020-11-24 17:53:38',NULL,'WOVN Example',NULL,NULL,0,0,NULL,0,0,NULL,0,'0',9,'/var/www/html','http://127.0.0.1:8080/','ascend','descend',2,'classic_website',1,1,NULL,40);
...
CREATE TABLE `mt_category` (
  ...
  `category_category_set_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `mt_category_set`
--
...
CREATE TABLE `mt_category_set` (
  `category_set_id` int(11) NOT NULL AUTO_INCREMENT,
  `category_set_blog_id` int(11) NOT NULL,
  `category_set_cat_count` int(11) NOT NULL DEFAULT '0',
  `category_set_created_by` int(11) DEFAULT NULL,
  `category_set_created_on` datetime DEFAULT NULL,
  `category_set_ct_count` int(11) NOT NULL DEFAULT '0',
  `category_set_modified_by` int(11) DEFAULT NULL,
  `category_set_modified_on` datetime DEFAULT NULL,
  `category_set_name` varchar(255) NOT NULL DEFAULT '',
  `category_set_order` mediumtext,
  PRIMARY KEY (`category_set_id`),
  KEY `mt_category_set_blog_id` (`category_set_blog_id`),
  KEY `mt_category_set_name` (`category_set_name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_category_set`
--

LOCK TABLES `mt_category_set` WRITE;
/*!40000 ALTER TABLE `mt_category_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_category_set` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_cd`
--
...
CREATE TABLE `mt_cd` (
  ...
  `cd_author_id` int(11) NOT NULL,
  `cd_authored_on` datetime DEFAULT NULL,
  `cd_blog_id` int(11) NOT NULL,
  `cd_content_type_id` int(11) NOT NULL,
  `cd_created_by` int(11) DEFAULT NULL,
  `cd_created_on` datetime DEFAULT NULL,
  `cd_ct_unique_id` varchar(40) NOT NULL,
  `cd_data` mediumblob,
  `cd_identifier` varchar(255) DEFAULT NULL,
  `cd_label` varchar(255) DEFAULT NULL,
  `cd_modified_by` int(11) DEFAULT NULL,
  `cd_modified_on` datetime DEFAULT NULL,
  `cd_status` smallint(6) NOT NULL,
  `cd_unique_id` varchar(40) NOT NULL,
  `cd_unpublished_on` datetime DEFAULT NULL,
  `cd_week_number` int(11) DEFAULT NULL,
  `cd_current_revision` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`cd_id`),
  UNIQUE KEY `mt_cd_unique_id` (`cd_unique_id`),
  KEY `mt_cd_label` (`cd_label`),
  KEY `mt_cd_ct_unique_id` (`cd_ct_unique_id`),
  KEY `mt_cd_content_type_id` (`cd_content_type_id`),
  KEY `mt_cd_site_author` (`cd_author_id`,`cd_authored_on`,`cd_blog_id`,`cd_ct_unique_id`),
  KEY `mt_cd_status` (`cd_status`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_cd`
--

LOCK TABLES `mt_cd` WRITE;
/*!40000 ALTER TABLE `mt_cd` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_cd` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_cd_meta`
--
...
CREATE TABLE `mt_cd_meta` (
  `cd_meta_cd_id` int(11) NOT NULL,
  `cd_meta_type` varchar(75) NOT NULL,
  `cd_meta_vchar` varchar(255) DEFAULT NULL,
  `cd_meta_vchar_idx` varchar(255) DEFAULT NULL,
  `cd_meta_vdatetime` datetime DEFAULT NULL,
  `cd_meta_vdatetime_idx` datetime DEFAULT NULL,
  `cd_meta_vinteger` int(11) DEFAULT NULL,
  `cd_meta_vinteger_idx` int(11) DEFAULT NULL,
  `cd_meta_vfloat` float DEFAULT NULL,
  `cd_meta_vfloat_idx` float DEFAULT NULL,
  `cd_meta_vblob` mediumblob,
  `cd_meta_vclob` mediumtext,
  PRIMARY KEY (`cd_meta_cd_id`,`cd_meta_type`),
  KEY `mt_cd_meta_type_vint` (`cd_meta_type`,`cd_meta_vinteger_idx`),
  KEY `mt_cd_meta_type_vdt` (`cd_meta_type`,`cd_meta_vdatetime_idx`),
  KEY `mt_cd_meta_type_vflt` (`cd_meta_type`,`cd_meta_vfloat_idx`),
  KEY `mt_cd_meta_type_vchar` (`cd_meta_type`,`cd_meta_vchar_idx`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_cd_meta`
--

LOCK TABLES `mt_cd_meta` WRITE;
/*!40000 ALTER TABLE `mt_cd_meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_cd_meta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_cd_rev`
--
...
CREATE TABLE `mt_cd_rev` (
  `cd_rev_id` int(11) NOT NULL AUTO_INCREMENT,
  `cd_rev_cd` mediumblob NOT NULL,
  `cd_rev_cd_id` int(11) NOT NULL,
  `cd_rev_changed` varchar(255) NOT NULL,
  `cd_rev_created_by` int(11) DEFAULT NULL,
  `cd_rev_created_on` datetime DEFAULT NULL,
  `cd_rev_description` varchar(255) DEFAULT NULL,
  `cd_rev_label` varchar(255) DEFAULT NULL,
  `cd_rev_modified_by` int(11) DEFAULT NULL,
  `cd_rev_modified_on` datetime DEFAULT NULL,
  `cd_rev_rev_number` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`cd_rev_id`),
  KEY `mt_cd_rev_cd_id` (`cd_rev_cd_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_cd_rev`
--

LOCK TABLES `mt_cd_rev` WRITE;
/*!40000 ALTER TABLE `mt_cd_rev` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_cd_rev` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_cf`
--
...
CREATE TABLE `mt_cf` (
  ...
  `cf_blog_id` int(11) NOT NULL,
  `cf_content_type_id` int(11) DEFAULT NULL,
  `cf_created_by` int(11) DEFAULT NULL,
  `cf_created_on` datetime DEFAULT NULL,
  `cf_default` varchar(255) DEFAULT NULL,
  `cf_description` varchar(255) DEFAULT NULL,
  `cf_modified_by` int(11) DEFAULT NULL,
  `cf_modified_on` datetime DEFAULT NULL,
  `cf_name` varchar(255) DEFAULT NULL,
  `cf_related_cat_set_id` int(11) DEFAULT NULL,
  `cf_related_content_type_id` int(11) DEFAULT NULL,
  `cf_required` tinyint(4) DEFAULT NULL,
  `cf_type` varchar(255) DEFAULT NULL,
  `cf_unique_id` varchar(40) NOT NULL,
  PRIMARY KEY (`cf_id`),
  UNIQUE KEY `mt_cf_unique_id` (`cf_unique_id`),
  KEY `mt_cf_blog_id` (`cf_blog_id`),
  KEY `mt_cf_content_type_id` (`cf_content_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_cf`
--

LOCK TABLES `mt_cf` WRITE;
/*!40000 ALTER TABLE `mt_cf` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_cf` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_cf_idx`
--
...
CREATE TABLE `mt_cf_idx` (
  `cf_idx_id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_idx_content_data_id` int(11) DEFAULT NULL,
  `cf_idx_content_field_id` int(11) DEFAULT NULL,
  `cf_idx_content_type_id` int(11) DEFAULT NULL,
  `cf_idx_created_by` int(11) DEFAULT NULL,
  `cf_idx_created_on` datetime DEFAULT NULL,
  `cf_idx_modified_by` int(11) DEFAULT NULL,
  `cf_idx_modified_on` datetime DEFAULT NULL,
  `cf_idx_value_blob` mediumblob,
  `cf_idx_value_datetime` datetime DEFAULT NULL,
  `cf_idx_value_double` double DEFAULT NULL,
  `cf_idx_value_float` float DEFAULT NULL,
  `cf_idx_value_integer` int(11) DEFAULT NULL,
  `cf_idx_value_text` mediumtext,
  `cf_idx_value_varchar` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`cf_idx_id`),
  KEY `mt_cf_idx_value_double` (`cf_idx_value_double`),
  KEY `mt_cf_idx_value_varchar` (`cf_idx_value_varchar`),
  KEY `mt_cf_idx_value_integer` (`cf_idx_value_integer`),
  KEY `mt_cf_idx_value_datetime` (`cf_idx_value_datetime`),
  KEY `mt_cf_idx_value_float` (`cf_idx_value_float`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_cf_idx`
--

LOCK TABLES `mt_cf_idx` WRITE;
/*!40000 ALTER TABLE `mt_cf_idx` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_cf_idx` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mt_config` VALUES (1,'DataAPIDisableSite 0,1\nMTReleaseNumber 0\nMTVersion 7.4\nPluginAlias Markdown=Markdown/Markdown.pl\nPluginAlias SmartyPants=Markdown/SmartyPants.pl\nPluginAlias SpamLookup - Keyword Filter=spamlookup/spamlookup_words.pl\nPluginAlias SpamLookup - Link=spamlookup/spamlookup_urls.pl\nPluginAlias SpamLookup - Lookups=spamlookup/spamlookup.pl\nPluginAlias Textile=Textile/textile2.pl\nPluginAlias WXR Importer=WXRImporter\nPluginAlias Widget Manager Upgrade Assistant=WidgetManager/WidgetManager.pl\nPluginSchemaVersion WidgetManager=1.1\nPluginSchemaVersion formattedtext=1.00\nPluginSwitch BlockEditor=1\nPluginSwitch FormattedText=1\nPluginSwitch FormattedTextForTinyMCE=1\nPluginSwitch GoogleAnalytics=1\nPluginSwitch Markdown/Markdown.pl=1\nPluginSwitch Markdown/SmartyPants.pl=1\nPluginSwitch Textile/textile2.pl=1\nPluginSwitch TinyMCE=1\nPluginSwitch WXRImporter=1\nPluginSwitch WidgetManager/WidgetManager.pl=1\nPluginSwitch spamlookup/spamlookup.pl=1\nPluginSwitch spamlookup/spamlookup_urls.pl=1\nPluginSwitch spamlookup/spamlookup_words.pl=1\nSchemaVersion 7.0046\nSecretToken MhhJcpkcZNxGERNURTf71JJUzVvpxf6ceughQthq\n');
/*!40000 ALTER TABLE `mt_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mt_content_type`
--
...
CREATE TABLE `mt_content_type` (
  ...
  `content_type_blog_id` int(11) NOT NULL,
  `content_type_created_by` int(11) DEFAULT NULL,
  `content_type_created_on` datetime DEFAULT NULL,
  `content_type_data_label` varchar(40) DEFAULT NULL,
  `content_type_description` mediumtext,
  `content_type_fields` mediumblob,
  `content_type_modified_by` int(11) DEFAULT NULL,
  `content_type_modified_on` datetime DEFAULT NULL,
  `content_type_name` varchar(255) DEFAULT NULL,
  `content_type_unique_id` varchar(40) NOT NULL,
  `content_type_user_disp_option` tinyint(4) DEFAULT NULL,
  `content_type_version` int(11) DEFAULT NULL,
  PRIMARY KEY (`content_type_id`),
  UNIQUE KEY `mt_content_type_unique_id` (`content_type_unique_id`),
  KEY `mt_content_type_blog_id` (`content_type_blog_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_content_type`
--

LOCK TABLES `mt_content_type` WRITE;
/*!40000 ALTER TABLE `mt_content_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_content_type` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mt_entry_rev` VALUES (1,'convert_breaks,allow_comments,author_id,status,text,authored_on,allow_pings,title,unpublished_on',1,'2020-11-24 18:09:06','',_binary 'SERG\0\0\0\0\0\0\0H\0\0\0\Z\0\0\0current_revision-\0\0\00\0\0\0keywords-\0\0\0\0\0\0\0title-\0\0\0サンプルページ\0\0\0excerpt-\0\0\0\0\0\0\0basename-\0\0\0post\0\0\0blog_id-\0\0\01\0\0\0\ncreated_by-\0\0\01\0\0\0unpublished_onU\0\0\0text-\0\0J<h2 class=\"hero__title\" data-wovn-original-property=\"{&quot;style&quot;:{&quot;fontSize&quot;:&quot;&quot;}}\">Web多言語化やサイト翻訳の課題に答えるソリューション</h2>\n<p class=\"hero__subtitle\">サービスの国際化に伴う開発やサイト運用、翻訳管理にかかる不要なコストを削減し、あなたのビジネスを世界に広げるサポートを行います。</p>\n<h2>WOVN.ioは、あなたの海外戦略を手助けするパートナー</h2>\n<p><span>WOVN.ioは、Webサイト・アプリを様々な言語に多言語化できるソリューションです。既存のWebサイト・アプリに後付けすることができ、多言語化に必要なシステム開発・多言語サイト運用にかかる、不要なコストの圧縮・人的リソースの削減・導入期間の短縮を実現します。</span></p>\n<h3>開発工数の削減</h3>\n<p><span>言語毎の開発を行うこと無く、Webサイトやアプリの多言語化を実現し、開発費用や人的コストを大幅にカットすることができます。</span></p>\n<h3>最適な運用の実現</h3>\n<p><span>エンジニア無しでWebサイトやアプリ内のテキスト翻訳・修正が可能です。更新情報をリアルタイムに翻訳し、反映することができます。</span></p>\n<h3>高品質な翻訳を提供</h3>\n<p><span>複数の翻訳方法を組み合わせることで、より正確で高品質な翻訳を実現します。また翻訳文は、翻訳資産として、活用することができます。</span></p>\n<h3>多言語化に必要なソリューションが全て揃っています</h3>\n<p><span>多言語化に伴うシステム開発やサイト運用、翻訳管理に対し課題を抱えていませんか。大規模なECや、強固なセキュリティが必要な管理画面、高品質な翻訳を必要とするIPコンテンツが豊富なブランディングページなど、あらゆるオンラインサービス多言語化における課題を解決するソリューションの提供を致します。</span></p>\0\0\0allow_pings-\0\0\00\0\0\0authored_on-\0\0\020201124180646\0\0\0\nping_count-\0\0\00\0\0\0class-\0\0\0entry\0\0\0week_number-\0\0\0202048\0\0\0\ncreated_on-\0\0\020201124180905\0\0\0\n__rev_tagsA\0\0\0\0\0\0\0	text_more-\0\0\0\0\0\0\0	author_id-\0\0\01\0\0\0status-\0\0\02\0\0\0\rcomment_count-\0\0\00\0\0\0convert_breaks-\0\0\0richtext\0\0\0allow_comments-\0\0\00\0\0\0atom_id-\0\0\0tag:127.0.0.1,2020://1.1\0\0\0modified_on-\0\0\020201124180905\0\0\0id-\0\0\01\0\0\0\n__rev_catsA\0\0\0\0',1,NULL,NULL,'2020-11-24 18:09:06',1);
...
CREATE TABLE `mt_fileinfo` (
  ...
  `fileinfo_cd_id` int(11) DEFAULT NULL,
  ...
  KEY `mt_fileinfo_cd_id` (`fileinfo_cd_id`),
...
INSERT INTO `mt_fileinfo` VALUES (1,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/archives.html',NULL,7,NULL,'/archives.html',NULL),(2,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/atom.xml',NULL,29,NULL,'/atom.xml',NULL),(3,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/mt.js',NULL,31,NULL,'/mt.js',NULL),(4,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/index.html',NULL,32,NULL,'/index.html',NULL),(5,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/rsd.xml',NULL,45,NULL,'/rsd.xml',NULL),(6,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/styles.css',NULL,49,NULL,'/styles.css',NULL),(7,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/archives.html',NULL,55,NULL,'/archives.html',NULL),(8,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/atom.xml',NULL,78,NULL,'/atom.xml',NULL),(9,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/mt.js',NULL,80,NULL,'/mt.js',NULL),(10,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/index.html',NULL,81,NULL,'/index.html',NULL),(11,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/rsd.xml',NULL,94,NULL,'/rsd.xml',NULL),(12,'index',NULL,1,NULL,NULL,NULL,'/var/www/html/styles.css',NULL,99,NULL,'/styles.css',NULL),(13,'Individual',NULL,1,NULL,NULL,1,'/var/www/html/2020/11/post.html',NULL,76,6,'/2020/11/post.html',NULL),(14,'Monthly',NULL,1,NULL,NULL,NULL,'/var/www/html/2020/11/index.html','20201101000000',85,7,'/2020/11/index.html',NULL);
...
CREATE TABLE `mt_group` (
  ...
  `group_display_name` varchar(255) DEFAULT NULL,
  `group_external_id` varchar(255) DEFAULT NULL,
  `group_modified_by` int(11) DEFAULT NULL,
  `group_modified_on` datetime DEFAULT NULL,
  `group_name` varchar(255) NOT NULL,
  `group_status` int(11) DEFAULT '1',
  PRIMARY KEY (`group_id`),
  KEY `mt_group_status` (`group_status`),
  KEY `mt_group_name` (`group_name`),
  KEY `mt_group_external_id` (`group_external_id`),
  KEY `mt_group_created_on` (`group_created_on`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `mt_group` WRITE;
/*!40000 ALTER TABLE `mt_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_group` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mt_log` VALUES (1,0,0,'upgrade','system',NULL,'2020-11-24 08:45:48',NULL,1,'\'admin\'ãŒãƒ‡ãƒ¼ã‚¿ãƒ™ãƒ¼ã‚¹ã‚’ãƒãƒ¼ã‚¸ãƒ§ãƒ³7.0046ã«ã‚¢ãƒƒãƒ—ã‚°ãƒ¬ãƒ¼ãƒ‰ã—ã¾ã—ãŸã€‚',NULL,NULL,'2020-11-24 08:45:48'),(2,0,0,'install','plugin',NULL,'2020-11-24 08:45:48',NULL,1,'\'admin\'ãŒãƒ—ãƒ©ã‚°ã‚¤ãƒ³(FormattedTextã€ãƒãƒ¼ã‚¸ãƒ§ãƒ³1.4ã€ã‚¹ã‚­ãƒ¼ãƒžãƒãƒ¼ã‚¸ãƒ§ãƒ³1.00)ã‚’ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«ã—ã¾ã—ãŸã€‚',NULL,NULL,'2020-11-24 08:45:48'),(3,0,0,'install','plugin',NULL,'2020-11-24 08:45:48',NULL,1,'\'admin\'ãŒãƒ—ãƒ©ã‚°ã‚¤ãƒ³(Widget Manager Upgrade Assistantã€ãƒãƒ¼ã‚¸ãƒ§ãƒ³1.1ã€ã‚¹ã‚­ãƒ¼ãƒžãƒãƒ¼ã‚¸ãƒ§ãƒ³1.1)ã‚’ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«ã—ã¾ã—ãŸã€‚',NULL,NULL,'2020-11-24 08:45:48'),(4,1,1,'edit','website',NULL,'2020-11-24 08:53:39','192.168.160.1',1,'ã‚µã‚¤ãƒˆã®å¤‰æ›´ãŒä¿å­˜ã•ã‚Œã¾ã—ãŸ','template_setã¯noneã‹ã‚‰HASH(0x55fdc8655d28)ã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, commenter_authenticatorsã¯noneã‹ã‚‰MovableTypeã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, nofollow_urlsã¯noneã‹ã‚‰1ã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, nameã¯noneã‹ã‚‰WOVN Exampleã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, site_urlã¯noneã‹ã‚‰http://127.0.0.1:8080/ã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, archive_pathã¯noneã‹ã‚‰/var/www/htmlã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, theme_idã¯noneã‹ã‚‰picoã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, archive_urlã¯noneã‹ã‚‰http://127.0.0.1:8080/ã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, page_layoutã¯noneã‹ã‚‰layout-wttã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, follow_auth_linksã¯noneã‹ã‚‰1ã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ, site_pathã¯noneã‹ã‚‰/var/www/htmlã«å¤‰æ›´ã•ã‚Œã¾ã—ãŸ',NULL,'2020-11-24 08:53:39'),(5,1,0,'new','website',NULL,'2020-11-24 08:53:39','192.168.160.1',1,'adminã«ã‚ˆã£ã¦ã‚µã‚¤ãƒˆã®ã€ŒWOVN Exampleã€(ID:1)ãŒä½œæˆã•ã‚Œã¾ã—ãŸ',NULL,NULL,'2020-11-24 08:53:39'),(6,1,1,'new','entry',NULL,'2020-11-24 09:09:05','192.168.160.1',1,'adminãŒè¨˜äº‹ã€Œã‚µãƒ³ãƒ—ãƒ«ãƒšãƒ¼ã‚¸ã€(ID:1)ã‚’è¿½åŠ ã—ã¾ã—ãŸã€‚','1',NULL,'2020-11-24 09:09:05');
...
CREATE TABLE `mt_objectasset` (
  ...
  `objectasset_cf_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `mt_objectcategory`
--
...
CREATE TABLE `mt_objectcategory` (
  `objectcategory_id` int(11) NOT NULL AUTO_INCREMENT,
  `objectcategory_blog_id` int(11) DEFAULT NULL,
  `objectcategory_category_id` int(11) NOT NULL,
  `objectcategory_cf_id` int(11) NOT NULL DEFAULT '0',
  `objectcategory_is_primary` tinyint(4) NOT NULL,
  `objectcategory_object_ds` varchar(50) NOT NULL,
  `objectcategory_object_id` int(11) NOT NULL,
  PRIMARY KEY (`objectcategory_id`),
  KEY `mt_objectcategory_category_id` (`objectcategory_category_id`),
  KEY `mt_objectcategory_blog_ds_tag` (`objectcategory_blog_id`,`objectcategory_object_ds`,`objectcategory_category_id`),
  KEY `mt_objectcategory_is_primary` (`objectcategory_is_primary`),
  KEY `mt_objectcategory_blog_ds_obj` (`objectcategory_blog_id`,`objectcategory_object_ds`,`objectcategory_object_id`,`objectcategory_category_id`),
  KEY `mt_objectcategory_object_ds` (`objectcategory_object_ds`),
  KEY `mt_objectcategory_object_id` (`objectcategory_object_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_objectcategory`
--

LOCK TABLES `mt_objectcategory` WRITE;
/*!40000 ALTER TABLE `mt_objectcategory` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_objectcategory` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mt_objecttag` (
  ...
  `objecttag_cf_id` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `mt_permission` VALUES (1,1,0,NULL,NULL,'2020-11-24 17:45:47',NULL,NULL,'2020-11-24 17:45:47',NULL,'\'administer\',\'edit_templates\',\'manage_plugins\',\'view_log\',\'create_site\',\'sign_in_cms\',\'sign_in_data_api\',\'manage_users_groups\',\'manage_content_types\',\'manage_content_data\'',NULL,0,NULL),(2,1,1,NULL,1,'2020-11-24 17:53:39','Default|Bottom',NULL,'2020-11-24 17:53:39',NULL,'\'administer_blog\',\'administer_site\',\'administer_website\',\'comment\',\'create_post\',\'create_site\',\'edit_all_posts\',\'edit_assets\',\'edit_categories\',\'edit_config\',\'edit_notifications\',\'edit_tags\',\'edit_templates\',\'manage_category_set\',\'manage_content_data\',\'manage_content_types\',\'manage_feedback\',\'manage_member_blogs\',\'manage_pages\',\'manage_themes\',\'manage_users\',\'publish_post\',\'rebuild\',\'send_notifications\',\'set_publish_paths\',\'upload\',\'view_blog_log\'',NULL,0,NULL);
...
--
-- Table structure for table `mt_rebuild_trigger`
--
...
CREATE TABLE `mt_rebuild_trigger` (
  `rebuild_trigger_id` int(11) NOT NULL AUTO_INCREMENT,
  `rebuild_trigger_action` int(11) DEFAULT NULL,
  `rebuild_trigger_blog_id` int(11) NOT NULL,
  `rebuild_trigger_created_by` int(11) DEFAULT NULL,
  `rebuild_trigger_created_on` datetime DEFAULT NULL,
  `rebuild_trigger_ct_id` int(11) DEFAULT NULL,
  `rebuild_trigger_ct_unique_id` varchar(40) DEFAULT NULL,
  `rebuild_trigger_event` int(11) DEFAULT NULL,
  `rebuild_trigger_modified_by` int(11) DEFAULT NULL,
  `rebuild_trigger_modified_on` datetime DEFAULT NULL,
  `rebuild_trigger_object_type` int(11) DEFAULT NULL,
  `rebuild_trigger_target` int(11) DEFAULT NULL,
  `rebuild_trigger_target_blog_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rebuild_trigger_id`),
  KEY `mt_rebuild_trigger_blog_id` (`rebuild_trigger_blog_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mt_rebuild_trigger`
--

LOCK TABLES `mt_rebuild_trigger` WRITE;
/*!40000 ALTER TABLE `mt_rebuild_trigger` DISABLE KEYS */;
/*!40000 ALTER TABLE `mt_rebuild_trigger` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mt_role` VALUES (1,1,'2020-11-24 17:45:48','ã‚µã‚¤ãƒˆã‚’ç®¡ç†ã§ãã¾ã™',0,NULL,'2020-11-24 17:45:48','ã‚µã‚¤ãƒˆç®¡ç†è€…','\'administer_site\'',NULL,NULL,NULL,NULL),(2,1,'2020-11-24 17:45:48','ãƒ•ã‚¡ã‚¤ãƒ«ã‚’ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰ã—ã€è¨˜äº‹(ã‚«ãƒ†ã‚´ãƒª)ã€ã‚¦ã‚§ãƒ–ãƒšãƒ¼ã‚¸(ãƒ•ã‚©ãƒ«ãƒ€)ã€ã‚¿ã‚°ã‚’ç·¨é›†ã—ã¦å…¬é–‹ã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ç·¨é›†è€…','\'comment\',\'create_post\',\'publish_post\',\'edit_all_posts\',\'edit_categories\',\'edit_tags\',\'manage_pages\',\'rebuild\',\'upload\',\'send_notifications\',\'manage_feedback\',\'edit_assets\',\'manage_content_data\',\'manage_category_set\'',NULL,NULL,NULL,NULL),(3,1,'2020-11-24 17:45:48','è¨˜äº‹ã‚’ä½œæˆã—ã€å„è‡ªã®è¨˜äº‹ã®ç·¨é›†ã¨ãƒ•ã‚¡ã‚¤ãƒ«ã®ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰ã€ãŠã‚ˆã³ãã‚Œã‚‰ã‚’å…¬é–‹ã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ãƒ¦ãƒ¼ã‚¶ãƒ¼','\'comment\',\'create_post\',\'publish_post\',\'upload\',\'send_notifications\'',NULL,NULL,NULL,NULL),(4,1,'2020-11-24 17:45:48','ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆã¨ãƒ†ãƒ¼ãƒžã®ç·¨é›†ã¨ç®¡ç†ã€åŠã³ãã‚Œã‚‰ã®å…¬é–‹ãŒã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ãƒ‡ã‚¶ã‚¤ãƒŠ','\'manage_themes\',\'edit_templates\',\'rebuild\',\'upload\',\'edit_assets\'',144,NULL,NULL,NULL),(5,1,'2020-11-24 17:45:48','ãƒšãƒ¼ã‚¸ã®ç®¡ç†ã€ãƒ•ã‚¡ã‚¤ãƒ«ã®ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰ã€ã‚µã‚¤ãƒˆã®ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆã‚’å…¬é–‹ã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ã‚¦ã‚§ãƒ–ãƒžã‚¹ã‚¿ãƒ¼','\'manage_pages\',\'rebuild\',\'upload\'',NULL,NULL,NULL,NULL),(6,1,'2020-11-24 17:45:48','è¨˜äº‹ã®ä½œæˆã€å„è‡ªã®è¨˜äº‹ã¨ã‚³ãƒ¡ãƒ³ãƒˆã‚’ç·¨é›†ã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ãƒ©ã‚¤ã‚¿ãƒ¼','\'comment\',\'create_post\'',NULL,NULL,NULL,NULL),(7,1,'2020-11-24 17:45:48','ã‚³ãƒ³ãƒ†ãƒ³ãƒ„ã‚¿ã‚¤ãƒ—ã€ã‚³ãƒ³ãƒ†ãƒ³ãƒ„ãƒ‡ãƒ¼ã‚¿ã€ã‚«ãƒ†ã‚´ãƒªã‚»ãƒƒãƒˆã®ç·¨é›†ã¨ç®¡ç†ãŒã§ãã¾ã™ã€‚',0,NULL,'2020-11-24 17:45:48','ã‚³ãƒ³ãƒ†ãƒ³ãƒ„ãƒ‡ã‚¶ã‚¤ãƒŠ','\'manage_content_types\',\'manage_content_data\',\'manage_category_set\'',NULL,NULL,NULL,NULL);
...
INSERT INTO `mt_session` VALUES ('7bc53448f5ed075bfef9f1d6607eb5429b725aa2',_binary 'SERG\0\0\0\0\0\0\0H\0\0\0\0\0\0mt_rebuild_tokenU\0\0\0magic_token-\0\0\0(11c097f278f459aef2c5854bbbf8eaa7fd790380\0\0\0	author_id-\0\0\01',NULL,NULL,'US','1',1606207548),('9e9601f830d0fb0ab1625e9610725fd0bb1244be',_binary 'SERG\0\0\0\0\0\0\0H\0\0\0\0\0\0	author_id-\0\0\01',NULL,'iwai@wovn.io','SI','admin',1606208019),('Notification messages',_binary 'SERG\0\0\0\0\0\0\0A\0\0\0H\0\0\0\0\0\0level-\0\0\0warning\0\0\0detail-\0\0\0�このメッセージを消すには、Mozilla::CA モジュールをインストールするか、mt-config.cgi に \"SSLVerifyNone 1\" を指定してください。\0\0\0text-\0\0\0+SSL 証明書の検証ができません。',NULL,NULL,'DW',NULL,1606207556),('NW','',NULL,NULL,'NW',NULL,1606124757),('System Information',_binary 'SERG\0\0\0\0\0\0\0H\0\0\0\0\0\0server_model-\0\0\0CGI\0\0\0total_sites-\0\0\00\0\0\0total_content_types-\0\0\00\0\0\0active_users-\0\0\01',NULL,NULL,'DW',NULL,1606207583);
...
CREATE TABLE `mt_template` (
  ...
  KEY `mt_template_content_type_id` (`template_content_type_id`),
...
INSERT INTO `mt_template_meta` VALUES (53,'modulesets','46,33,8,38,50,6',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(103,'modulesets','95,60,54,82,56,88,100,86,90',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(104,'modulesets','60,56,88,100,86,90',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(105,'modulesets','95,82,54',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `mt_templatemap` (
  ...
  `templatemap_cat_field_id` int(11) DEFAULT NULL,
  `templatemap_dt_field_id` int(11) DEFAULT NULL,
...
INSERT INTO `mt_templatemap` VALUES (5,'Category',1,NULL,1,NULL,0,NULL,1,63),(6,'Individual',1,NULL,1,NULL,0,NULL,1,76),(7,'Monthly',1,NULL,1,NULL,0,NULL,1,85),(8,'Page',1,NULL,1,NULL,0,NULL,1,87);
...
INSERT INTO `mt_touch` VALUES (1,0,'2020-11-24 08:53:46','author'),(3,1,'2020-11-24 09:09:06','entry'),(2,1,'2020-11-24 09:05:43','template');
...
-- Dump completed on 2020-11-24  9:12:32
